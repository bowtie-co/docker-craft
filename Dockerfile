...
RUN apt-get update && apt-get install -y \
    build-essential default-mysql-client libpng-dev libjpeg62-turbo-dev libfreetype6-dev libmagickwand-dev \
...
RUN chown -R $APP_USER:$APP_USER storage vendor web/cpresources
